...
**Argument: `$ARGUMENTS`** — if this contains "preapproved", skip the confirmation step in Phase 3 (step 4) and commit immediately.
...
5. **Report**: Summarize results as a checklist with pass/fail for each step. If any checks failed and could not be auto-fixed, stop and offer to fix them. Otherwise, proceed to Phase 3.
